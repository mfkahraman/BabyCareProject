...
namespace BabyCareProject.Services.InstructorServices
{
    public class InstructorService : IInstructorService
    {
        ...
        {
            var insturctor = _mapper.Map<Instructor>(createInstructorDto);
            await _instructorCollection.InsertOneAsync(insturctor);
        }
        ...
        public async Task<List<ResultInstructorDto>> GetAllInstroctarAsync()
        {
